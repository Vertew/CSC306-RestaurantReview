...
public final class RecyclerListBinding implements ViewBinding {
  ...
  private RecyclerListBinding(@NonNull LinearLayout rootView, @NonNull ImageView ivThumbnail,
  ...
  public static RecyclerListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new RecyclerListBinding((LinearLayout) rootView, ivThumbnail, tvDescription, tvName);
    }
